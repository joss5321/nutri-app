...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: '800', color: COLORS.text, lineHeight: 36, letterSpacing: -0.5 },
  ...
  error: { color: COLORS.error, fontSize: 12, marginTop: -6, paddingLeft: 4 },
  ...
  successTitle: { fontSize: 26, fontWeight: '800', color: COLORS.text, textAlign: 'center', letterSpacing: -0.5 },
  successSubtitle: {
